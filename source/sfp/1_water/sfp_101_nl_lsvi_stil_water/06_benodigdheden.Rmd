...
| Flora van België (Verloove & Van Rossum, 2023) en/of andere determinatiewerken (zie Bijlage \@ref(sec: Bijlage1)) |
...
### Secchi-schijf
Een secchi-schijf met een diameter van 20 cm (Figuur \@ref(fig: Figuur4)) wordt gebruikt om de secchi-diepte te bepalen. Het koord waaraan de secchi-schijf is bevestigd, is voorzien van een maatverdeling om de diepte te kunnen bepalen. Indien een secchi-schijf met andere diameter wordt gebruikt, dient dit vermeld te worden.
...
### Determinatiewerken
Relevante determinatiewerken worden in Bijlage xxx1xxx opgesomd.
