...
Tabel \@ref(tab:Tabel1) geeft een overzicht van de benodigde apparatuur en materiaal voor het nemen van een waterstaal. Onder 5.1, 5.2 en 5.3 worden een aantal specifieke benodigdheden van verdere uitleg voorzien.
...
![(#fig:Figuur1) Maatbeker (links) en staalname-emmer (rechts).](./media/image1.jpg){width="6.299660979877515in" height="4.722222222222222in"}
...
Table: (#tab:Tabel2) Analyses die uitgevoerd worden op de waterstalen van de respectievelijke recipiënten.
...
**Salpeterzuur 65%, suprapur, (HNO~3~):** Sterk zuur dat zowel irriterend en corrosief werkt. Draag handschoenen bij gebruik, voorkom inademing van dampen en contact met de huid en ogen.
