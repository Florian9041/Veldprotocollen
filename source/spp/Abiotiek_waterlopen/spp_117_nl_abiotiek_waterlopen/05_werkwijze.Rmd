...
### 2. Lokaliseren en documenteren van [staalnamepunt]{.mark}
...
-   De meting gebeurt steeds op 0,5 m diepte (vanaf het wateroppervlak gemeten), tenzij de waterloop minder dan 1 m diep is. Dan wordt de meting uitgevoerd op de helft van de waterdiepte.
    ...
    ### 5. Bemonstering waterkolom en het vullen van de recipiënten
...
### 6. Uitvoering veldmetingen

zie deelprotocol (SVP-115)

### 7. Aflevering stalen aan het labo
...
### 8. Digitalisatie van de gegevens op het staalnameformulier
...
### 1. Registratie van resultaten: staalnameformulier (naar VMM 2020)
