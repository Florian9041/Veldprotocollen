...
### 5.1.1 Voorbereiding terreinwerk
...
### 5.1.2 Lokaliseren en documenteren van staalnamepunt
...
### 5.1.6 Uitvoering veldmetingen

zie deelprotocol (SVP-115)

### 5.1.7 Aflevering stalen aan het labo
...
### 5.1.8 Digitalisatie van de gegevens op het staalnameformulier

Na de staalname worden de gegevens ingevoerd in het digitale staalnameformulier gedeeld door het Labo via Google Drive.

## 5.2 Registratie en bewaring van resultaten

### 5.2.1 Registratie van resultaten: staalnameformulier (naar VMM 2020)
