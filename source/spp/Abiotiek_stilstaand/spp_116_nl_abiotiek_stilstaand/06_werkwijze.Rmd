...
Controleer bij de aanvang van het veldwerk steeds de lijst van benodigdheden (zie 5. Benodigdheden).

### [Lokaliseren en documenteren van [staalname]{.mark}locatie]{.underline}
...
1.  [Bemonstering van de waterkolom door middel van een mengstaal]{.underline}

Zie deelprotocol SVP-114: Bemonstering waterkolom oppervlaktewater aan de hand van een waterstaal.

### [Uitvoering veldmetingen]{.underline}

### Zie deelprotocol SVP-115: Veldmeting abiotiek oppervlaktewater met behulp van WTW Multi 3430 veldmeter. {#zie-deelprotocol-svp-115-veldmeting-abiotiek-oppervlaktewater-met-behulp-van-wtw-multi-3430-veldmeter. .unnumbered}

2.  [Vullen van recipiënten voor het laboratorium (protocol SVP-114)]{.underline}

Zie deelprotocol SVP-114: Bemonstering waterkolom oppervlaktewater aan de hand van een waterstaal.

3.  [Secchi-diepte bepalen]{.underline}
...
4.  [Reinig het gebruikte materiaal]{.underline}
...
5.  [Aflevering stalen bij het Labo]{.underline}
...
6.  [Digitaliseer het staalnameformulier]{.underline}
...
-   Voor elk [staalnamepunt]{.mark} wordt ter plaatse een analoog [staalnameformulier]{.mark} ingevuld (zie hoger). Afwijkingen van de beschreven werkwijze voor het nemen van een mengstaal worden eveneens genoteerd.
...
-   De algemene gegevens, meetresultaten en opmerkingen, zoals genoteerd op het [staalnameformulier]{.mark}, worden zo snel mogelijk gedigitaliseerd door de staalnemer in het digitale staalnameformulier gedeeld door het Labo via Google Drive. Het originele staalnameformulier wordt bijgehouden door de projectverantwoordelijke.
...
-   Opslag van foto's op google drive met aanduiding van opnamedatum, waterlichaamcode en code [staalnamepunt]{.mark}.
